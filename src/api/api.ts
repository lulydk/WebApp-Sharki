...
export class RoutinesApi extends BaseAPI {
     ...
     * @memberof RoutinesApi
     */
    public findRoutines(search?: string, difficulty?: 'rookie' | 'beginner' | 'intermediate' | 'advanced' | 'expert', page?: number, size?: number, orderBy?: 'id' | 'name' | 'detail' | 'dateCreated' | 'averageRating' | 'difficulty' | 'categoryId' | 'creatorId', direction?: 'asc' | 'desc', options?: any) {
...
export class UsersApi extends BaseAPI {
     ...
     * @memberof UsersApi
     */
    public updateUser(body: UserWithoutPassword, options?: any) {
